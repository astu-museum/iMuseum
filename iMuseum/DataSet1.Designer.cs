...
WHERE        (e.PK_EXPONAT = cx.pk_exponat) AND (e.PK_CATEGORYEXPONAT = ce.pk_category) AND (e.PK_CATEGORYAUTHOR = ca.pk_category) AND 
    ...
    public partial class SOURCETableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO \"KOMRAZR\".\"SOURCE\" (\"NAME_\", \"ADDRESSS\") VALUES (?, ?)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ADDRESSS", global::System.Data.OleDb.OleDbType.WChar, 800, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ADDRESSS", global::System.Data.DataRowVersion.Current, false, null));
        }
